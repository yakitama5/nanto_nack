...
class ViewHistoryQuizScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<ViewHistoryQuizScreen> createState() =>
      _ViewHistoryQuizScreenState();
}
...
class _ViewHistoryQuizScreenState
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(viewHistoryQuizProvider.notifier).startQuiz();
    });
  }

  @override
  Widget build(BuildContext context) {
    final state = ref.watch(viewHistoryQuizProvider);
    final missionText = context.s.quiz4.missionText;
    final notifier = ref.read(viewHistoryQuizProvider.notifier);
...
class _ViewHistoryInsight extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
