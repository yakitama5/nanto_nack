...
class TranslationsQuiz2En {
	...
	/// en: 'Long press the 15th cell or use the + button in the bottom right to add an event'
	String get failureReason => 'Long press the 15th cell or use the + button in the bottom right to add an event';
...
class TranslationsQuiz3En {
	...
	/// en: 'The 'Meeting' is postponed to tomorrow! Move the event'
	String get missionText => 'The \'Meeting\' is postponed to tomorrow! Move the event';

	/// en: 'Long press the 'Meeting' event block, then drag and drop it to tomorrow's cell'
	String get failureReason => 'Long press the \'Meeting\' event block, then drag and drop it to tomorrow\'s cell';
...
class TranslationsQuiz3InsightEn {
	...
	/// en: 'How could you move an event by dragging?'
	String get title => 'How could you move an event by dragging?';

	/// en: 'Long press & drag moves events intuitively'
	String get subtitle => 'Long press & drag moves events intuitively';

	/// en: 'Long press drag is the standard grab-and-move operation'
	String get dragTitle => 'Long press drag is the standard grab-and-move operation';

	/// en: 'Dragging list items or event blocks by long pressing to 'grab' them is widely adopted in iOS and Android calendar and task apps.'
	String get dragDesc => 'Dragging list items or event blocks by long pressing to \'grab\' them is widely adopted in iOS and Android calendar and task apps.';

	/// en: 'Dropping places the item at that location'
	String get dropTitle => 'Dropping places the item at that location';

	/// en: 'Releasing (dropping) the dragged element at the destination moves the content there. This is the essence of drag and drop operation.'
	String get dropDesc => 'Releasing (dropping) the dragged element at the destination moves the content there. This is the essence of drag and drop operation.';

	/// en: 'Operation that matches visual intuition'
	String get intuitionTitle => 'Operation that matches visual intuition';

	/// en: 'UI that works exactly as intuitively expected, like 'pull to move', reduces cognitive load for users and represents excellent design.'
	String get intuitionDesc => 'UI that works exactly as intuitively expected, like \'pull to move\', reduces cognitive load for users and represents excellent design.';
}
