...
class _TranslationsQuiz1Xx extends TranslationsQuiz1Ja {
	...
	// Translations
	@override String get missionText => 'Fxbfxwy zyx jxgw zs pxz zyx ckzxwz homkzxw';
...
class _TranslationsQuiz2Xx extends TranslationsQuiz2Ja {
	...
	// Translations
	@override String get missionText => 'Uyxua zyx zso jxgw rj zyx Wosfzw ukzxpsfi';
...
class _TranslationsCommonXx extends TranslationsCommonJa {
	...
	// Translations
	@override String get appTitle => 'Jxgw';
	@override String get tabTop => 'Zso';
	@override String get tabEntertainment => 'Xjzxfzkrjexjz';
	@override String get tabSports => 'Wosfzw';
	@override String get noArticles => 'Js kfzrucxw';
	@override String get hideArticle => 'Yrmx zyrw kfzrucx';
	@override String get fontSizeLabel => 'Bsjz wrqx';
	@override String get fontSizeSmall => 'Wekcc';
	@override String get fontSizeMedium => 'Exmrhe';
...
class _TranslationsQuiz1InsightXx extends TranslationsQuiz1InsightJa {
	...
	// Translations
	@override String get title => 'Ysg mrm ish ajsg ohccrjp msgj gshcm fxbfxwy zyx jxgw?';
	@override String get subtitle => 'Ohccrjp msgj rw zyx hjrnxfwkc fxbfxwy pxwzhfx';
	@override String get pullTitle => 'Ohcc zs Fxbfxwy';
	@override String get pullDesc => 'Ohccrjp msgj sj k crwz wufxxj rw k fxbfxwy pxwzhfx osohckfrqxm di Zgrzxf kjm ekrc koow. Rz rw jsg kmsozxm di koow gsfcmgrmx.';
...
extension on TranslationsXx {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			'quiz1.missionText' => 'Fxbfxwy zyx jxgw zs pxz zyx ckzxwz homkzxw',
			'quiz1.insight.title' => 'Ysg mrm ish ajsg ohccrjp msgj gshcm fxbfxwy zyx jxgw?',
			'quiz1.insight.subtitle' => 'Ohccrjp msgj rw zyx hjrnxfwkc fxbfxwy pxwzhfx',
			'quiz1.insight.pullTitle' => 'Ohcc zs Fxbfxwy',
			'quiz1.insight.pullDesc' => 'Ohccrjp msgj sj k crwz wufxxj rw k fxbfxwy pxwzhfx osohckfrqxm di Zgrzxf kjm ekrc koow. Rz rw jsg kmsozxm di koow gsfcmgrmx.',
			...
			'common.tabSports' => 'Wosfzw',
			'common.noArticles' => 'Js kfzrucxw',
			'common.hideArticle' => 'Yrmx zyrw kfzrucx',
			'common.fontSizeLabel' => 'Bsjz wrqx',
			'common.fontSizeSmall' => 'Wekcc',
			'common.fontSizeMedium' => 'Exmrhe',
