          ...
          child: ListView(
            children: [
              _TrendItem(
                ...
                postCount: '1,234${sq.common.trends.postsCountSuffix}',
                snsTheme: snsTheme,
              ),
              _TrendItem(
                category: sq.common.trends.technologyTrending,
                title: sq.common.trends.flutter,
                postCount: '5,678${sq.common.trends.postsCountSuffix}',
                snsTheme: snsTheme,
              ),
              _TrendItem(
                category: sq.common.trends.gamingTrending,
                title: sq.common.trends.retroGames,
                postCount: '9,012${sq.common.trends.postsCountSuffix}',
                snsTheme: snsTheme,
              ),
              _TrendItem(
                category: sq.common.trends.trendingInJapan,
                title: sq.common.trends.uiUxQuiz,
                postCount: '3,456${sq.common.trends.postsCountSuffix}',
                snsTheme: snsTheme,
              ),
            ],
          ),
