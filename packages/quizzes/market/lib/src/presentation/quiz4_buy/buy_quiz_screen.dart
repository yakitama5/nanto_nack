...
class BuyQuizScreen extends ConsumerStatefulWidget {
  const BuyQuizScreen({super.key, this.onCompleted});

  final VoidCallback? onCompleted;

  @override
  ConsumerState<BuyQuizScreen> createState() => _BuyQuizScreenState();
}

class _BuyQuizScreenState extends ConsumerState<BuyQuizScreen> {
  static const _quizType = MarketQuizType.quiz4;
                ...
                builder: (ctx) {
                  ...
                  return QuizInsightContent(
                    ...
                    items: [
                      QuizInsightItem(
                        emoji: '📌',
                        title: insight.fixedTitle,
                        desc: insight.fixedDesc,
                      ),
                      QuizInsightItem(
                        emoji: '🔴',
                        title: insight.ctaTitle,
                        desc: insight.ctaDesc,
                      ),
                      QuizInsightItem(
                        emoji: '🛡️',
                        title: insight.safeTitle,
                        desc: insight.safeDesc,
                      ),
                    ],
                  );
                },
