...
class SwipeImageQuizScreen extends ConsumerStatefulWidget {
  const SwipeImageQuizScreen({super.key, this.onCompleted});

  final VoidCallback? onCompleted;

  @override
  ConsumerState<SwipeImageQuizScreen> createState() =>
      _SwipeImageQuizScreenState();
}

class _SwipeImageQuizScreenState extends ConsumerState<SwipeImageQuizScreen> {
  static const _quizType = MarketQuizType.quiz1;
