...
class PanChartQuizScreen extends ConsumerStatefulWidget {
  const PanChartQuizScreen({super.key, this.onCompleted});

  final VoidCallback? onCompleted;

  @override
  ConsumerState<PanChartQuizScreen> createState() =>
      _PanChartQuizScreenState();
}

class _PanChartQuizScreenState extends ConsumerState<PanChartQuizScreen> {
  static const _quizType = FinanceQuizType.quiz1;
                ...
                builder: (ctx) {
                  ...
                  return QuizInsightContent(
                    ...
                    items: [
                      QuizInsightItem(
                        emoji: '👆',
                        title: insight.panTitle,
                        desc: insight.panDesc,
                      ),
                      QuizInsightItem(
                        emoji: '⬅️',
                        title: insight.leftTitle,
                        desc: insight.leftDesc,
                      ),
                      QuizInsightItem(
                        emoji: '📜',
                        title: insight.viewTitle,
                        desc: insight.viewDesc,
                      ),
                    ],
                  );
                },
