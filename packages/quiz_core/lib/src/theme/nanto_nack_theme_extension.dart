...
class NantoNackThemeExtension
  ...
  /// TODOカテゴリーのブランドカラー（Microsoft To Do風ブルー）
  final Color todoCategoryColor;
  ...
  /// フードデリバリーカテゴリーのブランドカラー（UberEats風スカーレット）
  final Color deliveryCategoryColor;
  ...
  NantoNackThemeExtension lerp(
    ...
    return NantoNackThemeExtension(
      ...
      todoCategoryColor:
          Color.lerp(todoCategoryColor, other.todoCategoryColor, t)!,
      ...
      deliveryCategoryColor:
          Color.lerp(deliveryCategoryColor, other.deliveryCategoryColor, t)!,
